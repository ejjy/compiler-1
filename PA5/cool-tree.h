...
public:
   ...
   Formals get_formals();
   int get_formals_len();
   void set_offset(int temp);
   int get_offset();
   int get_new_temporary_offset() {
      num_temporary_offset++;
      return -1 * num_temporary_offset;
   }
   int get_var_num();
   int get_num_temporary_offset_used() {
      return num_temporary_offset;
   }
