...
public:
   ...
   Features get_attrs();
   Classes get_children(Classes classes);
   void install_methods(Features inherited);
   void install_attributes(Features inherited);
   Symbol get_attr_type(Symbol name);
   Feature get_method_by_name(Symbol name);
   Feature get_attr_by_name(Symbol name);
   void insert_let_id(Symbol id);
   bool check_let_id(Symbol id);
   void true_inside_let();
   void false_inside_let();
   void initial_inside_let();
   bool check_inside_let();
...
public:
   ...
   Expression copy_Expression();
   void dump(ostream& stream, int n);
   Case get_case_by_type(Symbol name);
   bool redef_branch();
